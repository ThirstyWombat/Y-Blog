...
export default function PostComponent({
  ...
  return (
    <div className="m-1 bg-darkRedditLighter rounded-md appearance-none rbg-grey p-6 shadow-[0_2px_4px_-3px_#7bdcf0,0_10px_20px_-2px_rgba(0,0,0,0.04)] focus:outline-none focus:ring-blue-300 focus:border-blue-400 focus:z-10 sm:text-sm">
      {renderPostActions()}
